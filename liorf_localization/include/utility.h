...
public:
    ...
    // base to lidar
    vector<double> b2LRotV;
    vector<double> b2LTransV;
    Eigen::Matrix3d b2LRot;
    Eigen::Vector3d b2LTrans;
    bool safeMode;
    double correspondenceDistance;
    bool enableDoensampling;
    ...
    ParamServer()
    {
        ...
        // base to lidar
        nh.param<vector<double>>("liorf_localization/base2LidarRot", b2LRotV, vector<double>());
        nh.param<vector<double>>("liorf_localization/base2LidarTrans", b2LTransV, vector<double>());
        b2LRot = Eigen::Map<const Eigen::Matrix<double, 3, 3, Eigen::RowMajor>>(b2LRotV.data());
        b2LTrans = Eigen::Map<const Eigen::Vector3d>(b2LTransV.data());
        ...
        nh.param<bool>("liorf_localization/safeMode", safeMode, false);

        nh.param<double>("liorf_localization/correspondenceDistance", correspondenceDistance, 1.0);
        nh.param<bool>("liorf_localization/enableDoensampling", enableDoensampling, false);
